      ...
      <Container>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            {/* WhatsApp Card */}
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border-2 border-green-200">
              ...
              <p className="text-gray-600 text-center mb-4 font-medium">+55 (38) 98860-1152</p>
              <Button
              ...
              <p className="text-sm text-gray-500 text-center mt-3">
                Clique no botão ou envie para: <br/>
                <span className="font-mono text-gray-700">+55 (38) 98860-1152</span>
              </p>
            </div>

            {/* Email Card */}
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border-2 border-purple-200">
              <div className="flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600 text-center mb-4 font-medium break-all">{email}</p>
              <Button
                onClick={() => window.location.href = `mailto:${email}`}
                className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 flex items-center justify-center gap-2"
              >
